...
export * from './reservation-laboratory-equipment-custom.controller';
...
import { ReservationLaboratoryEquipmentCustomController } from './reservation-laboratory-equipment-custom.controller';
...
export const RESERVATION_LABORATORY_EQUIPMENT_CONTROLLERS = [
  ...
  ReservationLaboratoryEquipmentCustomController,
];
